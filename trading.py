...
class Trading :
	...
	def show(self) : 
		for stock in self.getStocks():
			stock.show(buy_sell_pts=True, labels=True, line_labels=False, curve_fiting=False, interpolation=False, max_min=False, sockets=True, meanTrend=False, volumes=False)
